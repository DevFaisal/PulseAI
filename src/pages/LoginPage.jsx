...
const LoginPage = () => {
  return (
    <div className="max-w-full flex justify-between h-screen max-h-screen">
      <div className="flex justify-center items-center bg-white h-full w-full sm:w-1/2">
        <Login />
      </div>
      <div className="hidden sm:flex bg-contain justify-center items-center bg-yellow-400 h-full w-1/2">
        <img
